...
// void run_and_check_operator_hip(const OperatorRegistry::OperatorFunctions *op,
...
//             {
//                 // print if it's not near enough
//                 if (std::abs(output_data[j] - expected_data[j]) > 1e-4)
//                 {
//                     std::cout << "output_data[" << j << "] = " << output_data[j] << std::endl;
//                     std::cout << "expected_data[" << j << "] = " << expected_data[j] << std::endl;
//                 }
...
// #define RUN_TEST_CASE_HIP(operator_type, input_tensors, expected_tensors, attributes, expectedResult, device)  \
//     do                                                                                                         \
//     {                                                                                                          \
...
//         }                                                                                                      \
//                                                                                                                \
//         run_and_check_operator_hip(op, input_tensors, outputs, expected_tensors, attributes,                   \
...
// TEST(OperatorTestHIP, ConvOperator0)
// {
//     // Executing node: /model.0/conv/Conv
...
//     std::vector<Tensor> expected = {expectedOutput};

//     RUN_TEST_CASE_HIP(OperatorType::Conv, inputs, expected, attributes, OperatorExecuteResult::SUCCESS, &hipDevice);
// }

// TEST(OperatorTestHIP, SoftmaxOperator0)
// {
//     HipDevice hipDevice = HipDevice(0);
...
//     RUN_TEST_CASE_HIP(OperatorType::Softmax, inputs, expected, attributes, OperatorExecuteResult::SUCCESS, &hipDevice);
// }
